    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="
        ...
        <div class="auth-box p-4 bg-white rounded-lg">
            <div id="loginform">
                ...
                <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal mt-3 form-material" id="loginform" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-auto">
                                        <a href="{{ route('password.request') }}" id="to-recover" class="link font-weight-medium"><i class="fa fa-lock me-1"></i> Forgot password?</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-0 mt-4">
                                <div class="col-sm-12 justify-content-center d-flex">
                                    <p>
                                        ...
                                        <a href="{{ route('register') }}" class="text-info font-weight-medium ms-1">Sign Up</a>
                                    </p>
                                </div>
                            </div>
                        </form>
